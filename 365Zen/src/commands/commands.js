...
function sendreduce1() {
	Office.context.mailbox.item.subject.setAsync("MoveZen Listing Update");
	// Office.context.mailbox.item.body.setAsync("This is the body of the email.");
	prependHtmlBody(`<p>Hi!</p><br>
...
Office.onReady(info => {
  if (info.host === Office.HostType.Outlook) {
	document.getElementById("insertreduce1").onclick = sendreduce1;
	document.getElementById("insertreduce2").onclick = sendreduce2;
	document.getElementById("insertreduce3").onclick = sendreduce3;
